...
Before this I was a Postdoc in [CREATE](https://www.create.humanities.uva.nl/) working to improve the Computer Vision capabilities of the [CLARIAH](https://clariah.nl/) infrastructure. This followed my first Postdoc position at the [ISIS group](https://ivi.fnwi.uva.nl/isis/) in the [SEMIA](https://sensorymovingimagearchive.humanities.uva.nl/)project. In SEMIA I worked on techniques for exploring AV archives based on perceptual and sensory features.
