...
The tool's development arc — from proof of concept to prototype to usable software — was included as a case study in the [Alan Turing Institute's roadmap *Towards a National Research Software Engineering Capability in Arts and Humanities Research*](https://pure.port.ac.uk/ws/portalfiles/portal/109224765/Towards_a_National_Research_Software_Engineering_Capability_in_Arts_and_Humanities_Research_a_Roadmap.pdf), a report that outlines a strategic plan to establish a national, Arts & Humanities RSE capability, ensuring that digital expertise is accessible and sustainable within A&H research.

## Roadmap and public engagement
The tool is very new and just at the beginning of its development. There is still a lot testing ahead and development for it to mature. We have approached different communities steer this development, for example at the **Audiovisual Digital Humanities SIG at [DH2025](https://dh2025.adho.org/)** (Lisbon), the largest international Digital Humanities conference. It also featured at the [[../Events/DH2026|next edition of ADHO in Daejeon, South Korea]], during the AVinDH workshop's Tool Cavalcade session.
