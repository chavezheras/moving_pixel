...
I am a Senior Lecturer (≈Associate Professor) in Computational Humanities and AI Media at [King's College London](https://www.kcl.ac.uk/people/daniel-chavez-heras)  where I am part of the [Computational Humanities Group](https://www.kcl.ac.uk/research/computational-humanities-research-group), the [Creative AI Lab](https://creative-ai.org/info), and an affiliate of [King's AI Institute](https://www.kcl.ac.uk/ai) who recently did [a profile of my work](https://www.kcl.ac.uk/meet-dr-daniel-chavez-heras) for their spotlight series. I have over a decade of experience in the cultural and creative industries with a focus on the screen sector, including projects and collaborations with the British Film Institute, the BBC, and the British Council.

My work combines critical frameworks in the history and theories of cinema, television, and photography, with advanced technical practice in creative and scientific computing, including applied machine learning technologies (AI). I aim to understand screen culture as a complex dynamic system, drawing on computational modelling and simulation techniques that blend creative and scientific computing.
